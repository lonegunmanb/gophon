...
func TestScanPackage_ExtractsTypes(t *testing.T) {
	...
	assert.Equal(t, "github.com/lonegunmanb/gophon/pkg/test-harness", stringAType.PackagePath)
	...
	assert.Equal(t, "github.com/lonegunmanb/gophon/pkg/test-harness", stringBType.PackagePath)
	...
	assert.Equal(t, "github.com/lonegunmanb/gophon/pkg/test-harness", userType.PackagePath)
	...
	assert.Equal(t, "github.com/lonegunmanb/gophon/pkg/test-harness", userServiceType.PackagePath)
	...
	assert.Equal(t, "github.com/lonegunmanb/gophon/pkg/test-harness", serviceType.PackagePath)
